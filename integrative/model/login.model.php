...
class UserModel {
   ...
   public function verifyUser($username, $password) {
        ...
        $sql="select * from students where id = '" .$username."' and  dbirth = '" .$password ."'";
    ...
    public function verifyFaculty($id,$dbirth){

         
        $sql="select * from faculty where id= '$id' and dbirth = '$dbirth'";
        $result = $this->dbConnection->query($sql);
